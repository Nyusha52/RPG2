...
class Knight():
    type = None
    attak = None
    have_weapon = {'impact_strength_war' : None, 'impact_strength_archer' : None, 'impact_strength_magician' : None}
    ...
    def type_attack_knight_war(self):
        ...
        if Knight.have_weapon['impact_strength_archer'] == None and  Knight.have_weapon['impact_strength_magician'] == None:
            x = "1"
        if Knight.have_weapon['impact_strength_archer'] != None and  Knight.have_weapon['impact_strength_magician'] == None:
